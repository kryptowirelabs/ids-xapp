...
static
ran_param_type_t dec_ran_param_def_lst(RANParameter_Definition_Choice_LIST_t* src)
{
  assert(src != NULL);
...
static
ran_param_type_t dec_ran_param_def_strct(RANParameter_Definition_Choice_STRUCTURE_t* src)
{
  assert(src != NULL);
