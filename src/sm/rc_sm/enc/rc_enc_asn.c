...
static
RANParameter_Definition_Choice_LIST_t enc_ran_param_def_lst(ran_param_type_t* src)
{
  assert(src != NULL);
...
static
RANParameter_Definition_Choice_STRUCTURE_t enc_ran_param_def_strct(ran_param_type_t* src)
{
  assert(src != NULL);
...
static
RANParameter_Definition_t enc_ran_param_def(ran_param_def_t* src)
{
  assert(src != NULL);
  ...
  case LIST_RAN_PARAMETER_TYPE:
    dst.ranParameter_Definition_Choice->present = RANParameter_Definition_Choice_PR_choiceLIST;
    dst.ranParameter_Definition_Choice->choice.choiceLIST = calloc(1, sizeof(RANParameter_Definition_Choice_LIST_t));
    assert(dst.ranParameter_Definition_Choice->choice.choiceLIST != NULL && "Memory exhausted");
    *dst.ranParameter_Definition_Choice->choice.choiceLIST = enc_ran_param_def_lst(src->lst);
    break;

  case STRUCTURE_RAN_PARAMETER_TYPE:
    dst.ranParameter_Definition_Choice->present = RANParameter_Definition_Choice_PR_choiceSTRUCTURE;
    dst.ranParameter_Definition_Choice->choice.choiceSTRUCTURE = calloc(1, sizeof(RANParameter_Definition_Choice_STRUCTURE_t));
    assert(dst.ranParameter_Definition_Choice->choice.choiceSTRUCTURE != NULL && "Memory exhausted");
    *dst.ranParameter_Definition_Choice->choice.choiceSTRUCTURE = enc_ran_param_def_strct(src->strct);
    break;
